...
import GATEWAY_PROVIDERS from '@/lib/constants/gateway-providers.json';
import LOCAL_PROVIDERS from '@/lib/constants/local-providers.json';
import MODEL_PROVIDERS from '@/lib/constants/model-providers.json';
import { cn } from '@/lib/utils';

type Provider = (typeof MODEL_PROVIDERS)[number];
...
export default function ApiKeysPage() {
	return (
		<div>
			...
			<div className="mb-8">
				<div className="flex ">
					<div className="bg-bg-secondary px-4 py-2 font-semibold text-lg text-white">
						Model Providers
					</div>
